...
for ii = 1:numel(simtype)
    ...
    files.base      = 'D:\Documents\ebb_corr\paper_sims';
%     files.D         = [files.base '\' simtype{ii} '_sim_' num2str(snr) 'dB_001.mat'];
...
%     matlabbatch{2}.spm.tools.beamforming.sources.visualise = 0;
    ...
    matlabbatch{1}.spm.tools.beamforming.features.plugin.tdcov.ntmodes = [4];
